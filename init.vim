...
Plug 'benmills/vimux'
# Plug 'powerline/powerline', { 'rtp': '$POWERLINE_HOME/powerline/bindings/vim' }
...
call plug#end
call deoplete#custom#option('ignore_source', { '-': ['around', 'buffer'] } )
call neomake#configure#automake('mrwi', 500)
